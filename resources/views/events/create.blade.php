    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    <li class="nav-item"><a class="nav-link active" href="/events">Quản lý sự kiện</a></li>
                </ul>
            </div>
        </nav>
        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="mb-3 pt-3 pb-2">
              ...
              <form class="needs-validation" novalidate action="/events/create" method="post">
              @csrf 
                <div class="row">
                    <div class="col-12 col-lg-4 mb-3">
                        <label for="inputName">Tên</label>
                        <!-- adding the class  to the input, shows the invalid feedback below -->
                ...
                <a href="/events" class="btn btn-link">Bỏ qua</a>
            </form>
